...
Browser("Home page").Page("Checkout").WebEdit("billing[email]").Set "paras@gmail.com" @@ hightlight id_;_Browser("Home page").Page("Checkout").WebEdit("billing[email]")_;_script infofile_;_ZIP::ssf97.xml_;_
...
Browser("Home page").Page("Checkout").WebButton("Continue_2").Click @@ hightlight id_;_Browser("Home page").Page("Checkout").WebButton("Continue 2")_;_script infofile_;_ZIP::ssf106.xml_;_
Browser("Home page").Page("Checkout").WebElement("checkout-step-shipping_method").Click @@ hightlight id_;_Browser("Home page").Page("Checkout").WebElement("checkout-step-shipping method")_;_script infofile_;_ZIP::ssf107.xml_;_
